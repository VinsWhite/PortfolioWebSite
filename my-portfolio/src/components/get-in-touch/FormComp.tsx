  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 py-20 px-2">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg relative">
        ...
        {animationSent && (
          <Lottie
            className="w-40 absolute top-1/2  -translate-y-1/2 right-1/2 transform translate-x-1/2"
        ...
        {animationNotSent && (
          <Lottie
            className="w-40 absolute top-1/2  -translate-y-1/2 right-1/2 transform translate-x-1/2"
            animationData={notSentAnimation}
          />
        )}
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <label htmlFor="privacy">
              <Link className="hover:underline underline-offset-1 ms-2" to="/privacy-policy">
                {t('getintouch.check')}
              </Link>
            </label>
          </div>
